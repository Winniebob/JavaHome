...
public class Cart<T extends Food> {
    ...
    {
        boolean proteins = foodstuffs.stream().anyMatch(T::getProteins);
        boolean fats = foodstuffs.stream().anyMatch(T::getFats);
        boolean carbohydrates = foodstuffs.stream().anyMatch(T::getCarbohydrates);
